...
//    public static final ExecutorService EXECUTOR = Executors.newFixedThreadPool(10);
    ...
    public enum Shader {
         ...
         *
         * @see AsciiVideo#createMappedChars(CharSequence)
         * */
...
//    private float charSpacingEm = DEFAULT_CHARACTER_SPACING_EM;
    ...
    public AsciiVideo(@NotNull Path inputImagePath, @Nullable Shader shader) {
...
//        System.setProperty("java.library.path", System.getProperty("java.library.path") + ";" + sketchPath() + "lib/processing/video/windows-amd64");
...
//        printArray(Capture.list());
        ...
        src = new Capture(this, 60, 60, "pipeline:autovideosrc");
        src.start();
...
//        }
    ...
    public static void main(String[] args) {
        ...
        final PApplet main = new AsciiVideo(input_img, null);
