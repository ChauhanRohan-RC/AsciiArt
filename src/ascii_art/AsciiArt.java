...
//    public static final ExecutorService EXECUTOR = Executors.newFixedThreadPool(10);
    ...
    public enum Shader {
         ...
         *
         * @see AsciiArt#createMappedChars(CharSequence)
         * */
        ...
        public char getCharacterForBrightness255(int brightness /* [0, 255] */) {
            return getMappedChars()[brightness];
        }

        public char getCharacterForBrightness01(float brightness /* [0, 1] */) {
            return getCharacterForBrightness255(floor(map(brightness, 0f, 1f, 0, 255)));
        }
    ...
    public static final int DEFAULT_SRC_RES_SCALE_PIXEL_TOLERANCE = 8;
    ...
    public static final float DEFAULT_FONT_SIZE = 2.0f;
...
//    PFont font;
    ...
    public AsciiArt(@NotNull Path inputImagePath, @Nullable Shader shader) {
...
//    }
    ...
    private static int computeBrightness255(int argb) {
        return round(U.luminance255(argb));
    }
...
//        textFont(font, fontSize);
        ...
        scale(nw * fontSize / src.width, nh * fontSize / src.height);
        ...
        for (int y = 0; y < src.height; y++) {
            ...
            translate(0,  (lineSpacing / fontSize));
            if (sb != null) {
                sb.append('\n');
            }
        }
...
//        }
    ...
    public static void main(String[] args) {
        ...
        final PApplet main = new AsciiArt(input_img, null);
