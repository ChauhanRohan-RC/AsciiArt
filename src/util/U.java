...
public class U {
    ...
    /**
     * @return the relative luminance of the given color, in range [0, 255]
     * */
    public static float relativeLuminance255(int r, int g, int b) {
     ...
     * @return the relative luminance of the given color, in range [0, 255]
     * */
    public static float relativeLuminance255(int rgb) {
        return relativeLuminance255(red255(rgb), green255(rgb), blue255(rgb));
    }


    /**
     * @return the perceived luminance of the given color, in range [0, 255]
     * */
    public static float perceivedLuminance255(int r, int g, int b) {
     ...
     * @return the perceived luminance of the given color, in range [0, 255]
     * */
    public static float perceivedLuminance255(int rgb) {
        return perceivedLuminance255(red255(rgb), green255(rgb), blue255(rgb));
    }
